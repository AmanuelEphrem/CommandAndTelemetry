...
def create_list(img_whole):
    ...
    fin_arr = [img_whole[i:i+200] for i in range(0, len(img_whole), 250)] # Splits the bytearray into n bytearrays, where n is the value of the length of img_whole / 250 rounded up.
